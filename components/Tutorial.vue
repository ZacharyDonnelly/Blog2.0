  ...
  <div class="items-top relative flex min-h-screen justify-center bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
      ...
      <div class="mt-8 overflow-hidden bg-white p-6 shadow sm:rounded-lg">
        <h2 class="text-2xl font-semibold leading-7">Welcome to your Nuxt Application</h2>
        ...
        <p class="mt-4 border-t border-dashed pt-4 text-gray-800">
          ...
          <code class="rounded border bg-gray-100 p-1 text-sm">components/Tutorial.vue</code>
          and start coding in
          <code class="rounded border bg-gray-100 p-1 text-sm">pages/index.vue</code>. Have fun!
        </p>
      </div>
